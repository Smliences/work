	...
	<body>
		...
		<div id="all">
			...
			<main id="main">				
				...
				<!-----------------------------------登录部分-------------------------------------->
				<form id="login_form" method="post" action="${pageContext.request.contextPath }/user_login.action">
			        <div class="text">
			            <h2>用 户 登 录</h2>
			        </div>
			        <div id="registerSuccess">${registmessage }</div>
			        <div class="get">
			        ...
			        <div id="left">
			            <a href="${pageContext.request.contextPath }/question_listpage.action">游客登录</a>
			        </div>
			        <div id="middle">
			            <a href="${pageContext.request.contextPath}/manager_login.action">管理员登录</a>
			        </div>
			        <div id="right">
